...
namespace Vienna.Extensions
{
    public static class LinqXmlExtensions
    {
        ...
        public static XElement GetElementOrThrow(this XElement el, string name)
        {
            if (el == null) throw new ArgumentNullException("el");
        ...
        public static Vector2 AttributesAsVector2(this XElement el, string xname, string yname)
        {
